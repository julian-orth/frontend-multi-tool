...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const path = localizeHref("/tools/css-minifier", locale);
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        de: `${SITE_CONFIG.domain}/tools/css-minifier`,
        en: `${SITE_CONFIG.domain}/en/tools/css-minifier`,
      },
    },
  };
}
  ...
  return (
    <>
      <ToolSchema
        ...
        url={localizeHref("/tools/css-minifier", locale)}
      ...
      <div className="px-6 py-8">
        <div className="mx-0 max-w-7xl">
          ...
          <div className="mt-16 space-y-12">
            ...
            <section>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {c.useCasesSection.items.map((item) => (
                  <div
                    key={item.title}
                    className="rounded-xl border border-teal-200 bg-teal-50/50 p-6 dark:border-teal-800 dark:bg-teal-950/20"
                  >
            ...
            <section>
              <h2 className="mb-4 text-3xl font-bold text-gray-900 dark:text-gray-50">
                {c.featuresSection.heading}
              </h2>
              <div className="space-y-6">
                {c.featuresSection.items.map((item) => (
                  <div
                    key={item.title}
