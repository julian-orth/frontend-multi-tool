...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const path = localizeHref("/tools/color-picker", locale);
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        de: `${SITE_CONFIG.domain}/tools/color-picker`,
        en: `${SITE_CONFIG.domain}/en/tools/color-picker`,
      },
    },
  };
}
  ...
  return (
    <>
      <ToolSchema
        ...
        url={localizeHref("/tools/color-picker", locale)}
        ...
        <div className="mx-0 max-w-7xl">
          <div className="mb-8">
            ...
            <div className="mb-3 flex items-start justify-between gap-4">
              ...
              <FavoriteButton toolId="color-picker" toolName={c.shortTitle} />
            </div>
            ...
            <section>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                {c.formats.map((item) => (
                  <div
                    key={item.title}
                    className="rounded-xl border border-pink-200 bg-pink-50/50 p-6 dark:border-pink-800 dark:bg-pink-950/20"
                  >
                    ...
                    <p className="mb-2 text-gray-700 dark:text-gray-300">
                      {item.formatLabel}:{" "}
                      <code className="font-mono">{item.format}</code>
                    </p>
