...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const path = localizeHref("/tools/timestamp-converter", locale);
  ...
  return (
    <>
      <ToolSchema
        name={c.title}
        description={c.metaDescription}
        url={localizeHref("/tools/timestamp-converter", locale)}
        keywords={c.keywords}
      />
        ...
        <div className="mx-0 max-w-7xl">
          <div className="mb-8">
            ...
            <div className="mb-3 flex items-start justify-between gap-4">
              ...
              <FavoriteButton toolId="timestamp-converter" toolName={c.h1} />
            </div>
