...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const path = localizeHref("/tools/hash-generator", locale);
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        de: `${SITE_CONFIG.domain}/tools/hash-generator`,
        en: `${SITE_CONFIG.domain}/en/tools/hash-generator`,
      },
    },
  };
}
  ...
  return (
    <>
      <ToolSchema
        name={c.title}
        description={c.metaDescription}
        url={localizeHref("/tools/hash-generator", locale)}
        keywords={c.keywords}
      />
        ...
        <div className="mx-0 max-w-7xl">
          <div className="mb-8">
            ...
            <div className="mb-3 flex items-start justify-between gap-4">
              ...
              <FavoriteButton toolId="hash-generator" toolName={c.h1} />
            </div>
